...
namespace flashinfer::sparse_mla_sm120::v3_backup {

// Decode-v3 BACKUP: frozen snapshot of decode-v3 at commit 41ac1687
// (cp.async Q overlap landed, 16/16 wins vs v2, 12/16 wins vs jasl).
// Used as the regression baseline for future decode-v3 optimization —
// any new v3 change should be A/B-checked against this snapshot.
//
// Wrapped in a sub-namespace so identical constant/symbol names don't
// collide with the live decode-v3 kernel in the same translation unit.
//
